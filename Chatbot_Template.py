...
class OrderBotGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Title_acc_to_you  Chatbot")
        ...
        self.context = [{'role': 'system', 'content': """ 
                ...
                Place your prompt here what you want for instance Pizza bot so write in natural language 
                         how pizza bot must act or Elon Musk bot etc . etc 
